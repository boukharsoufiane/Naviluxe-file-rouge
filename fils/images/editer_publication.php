    ...
    <div class="site-wrap">
        ...
        <div class="site-section" id="profile-header">
            <div class="container">
                <div id="liste">
                    ...
                    <form action="" method="post">
                        <button type="submit" name="commande">Gestion des réservation</button>
                    </form>
                    <form action="" method="post">
        ...
        <div class="py-5">
            <div class="container" id="historique">
                ...
                if ($publication == "" && $formAnnonce == "" && $detail == "" && $annonecTable == "" && $output == "" && $informationAgence == "" && (!isset($_GET["bateau"]))) {
            ...
            <div class="container">
                <div class="row">
                    ...
                    if (isset($_GET["bateau"]) && $publication == "" && $detail == "" && $formAnnonce == "" && $output == "" && $annonecTable == "" ) {
